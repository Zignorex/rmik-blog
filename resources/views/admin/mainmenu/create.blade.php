...
@section('content')
    ...
    <div class="col-lg-6">
        ...
        <form action="{{ url('admin/mainmenu/create') }}" method="POST" enctype="multipart/form-data">
            ...
            <br>
            <input type="submit" name="submit" class="btn btn-md btn-info" value="Tambah Data">
            <a href="{{ url('admin/mainmenu') }}" class="btn btn-md btn-danger"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
        </form>
    </div>
@endsection
@section('js')
