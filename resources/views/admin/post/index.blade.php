...
<h2>Posts</h2>
    ...
    @endif
    <a href="{{ url('admin/post/create') }}" class="btn btn-md btn-dark mb-3"><i class="fas fa-plus"></i> Tambah Data</a>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('admin/post/edit/'.$post->id) }}" class="btn btn-warning warning-md"><i class="far fa-edit"></i> Edit</a>
