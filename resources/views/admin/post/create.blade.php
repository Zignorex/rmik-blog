...
@section('content')
    ...
    <div class="col-lg-6">
        ...
        <form action="{{ url('admin/post/create') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="submit" name="submit" class="btn btn-md btn-dark" value="Tambah Data">
            <a href="{{ url('admin/post') }}" class="btn btn-md btn-danger"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
        </form>
    </div>
